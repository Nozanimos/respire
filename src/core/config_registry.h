...
static const ConfigParamEntry CONFIG_PARAM_TABLE[] = {
    ...
    { "retention_pattern",   "retention_pattern",  CONFIG_TYPE_INT,  offsetof(AppConfig, retention_pattern),   {.int_val = 0} },
    { "retention_start_empty","retention_start_empty",CONFIG_TYPE_BOOL,offsetof(AppConfig, retention_start_empty),{.bool_val = true} },
    { "pattern_seq1_type",   "pattern_seq1_type",  CONFIG_TYPE_INT,  offsetof(AppConfig, pattern_seq1_type),   {.int_val = 1} },
    { "pattern_seq1_count",  "pattern_seq1_count", CONFIG_TYPE_INT,  offsetof(AppConfig, pattern_seq1_count),  {.int_val = 1} },
    { "pattern_seq2_type",   "pattern_seq2_type",  CONFIG_TYPE_INT,  offsetof(AppConfig, pattern_seq2_type),   {.int_val = 0} },
    { "pattern_seq2_count",  "pattern_seq2_count", CONFIG_TYPE_INT,  offsetof(AppConfig, pattern_seq2_count),  {.int_val = 2} },
