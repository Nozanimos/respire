...
void handle_config_widget_events(ConfigWidget* widget, SDL_Event* event,
    ...
    if (event->type == SDL_MOUSEMOTION) {
        ...
        // ─────────────────────────────────────────────────────────────────────
        // DRAG DÉSACTIVÉ POUR MODE NUMERIC (comportement non souhaité)
        // ─────────────────────────────────────────────────────────────────────
        // Le drag est conservé uniquement pour le mode "time" si nécessaire dans le futur
        // Pour le mode "numeric", seul le clic gauche/droite est utilisé
    }
    // ═════════════════════════════════════════════════════════════════════════
    // ÉVÉNEMENT: MOLETTE
    // ═════════════════════════════════════════════════════════════════════════
    ...
    // ═════════════════════════════════════════════════════════════════════════
        ...
        if (on_roller) {
            if (strcmp(widget->widget_display_type, "time") == 0) {
                ...
                // ─────────────────────────────────────────────────────────────
                // MODE NUMERIC : Clic gauche/droite pour ±1 (PAS de drag)
                // ─────────────────────────────────────────────────────────────
                int relative_x = mx - roller_screen_rect.x;
                int half_width = roller_screen_rect.w / 2;
                ...
                // NE PAS démarrer le drag (désactivé pour mode numeric)
                // widget->is_dragging = false; // Pas besoin, reste à false
            }
        }
    }
    // ═════════════════════════════════════════════════════════════════════════
    ...
    // ═════════════════════════════════════════════════════════════════════════
        ...
        // Arrêter le drag (mode time uniquement, car désactivé pour numeric)
        widget->is_dragging = false;
    }
}
